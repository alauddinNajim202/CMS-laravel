...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Custom Script Table</h4>
    <div class="card">
                ...
                <div class="card-header flex-column flex-md-row">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            <a href="{{route('custom-script.create')}}" class="btn btn-secondary create-new btn-primary" tabindex="0"
...
@push('scripts')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('custom-script.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('custom-script.destroy', ':id') }}';
