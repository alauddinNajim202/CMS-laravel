    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Ideal Preceptor Section</h4>
                        <div class="mt-4">
                            <form action="{{ route('cms.landing-page.ideal-preceptor.update') }}" method="POST"
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Button Text" name="button_text" value="{{ $data[3]->button_text }}">
                                        @error('button_text')
                                        <div style="color: red">{{$message}}</div>
                                        @enderror
                                    </div>
