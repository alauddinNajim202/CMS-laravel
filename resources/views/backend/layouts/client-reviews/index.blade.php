            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="display: flex;justify-content: end;"><a href="{{ route('client-reviews.create') }}"
...
@push('scripts')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('client-reviews.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('client-reviews.destroy', ':id') }}';
